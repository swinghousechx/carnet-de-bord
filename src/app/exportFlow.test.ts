...
describe('defaultRecapMonth', () => {
  it('plus ancien mois en retard s’il en reste, sinon mois courant', () => {
    expect(defaultRecapMonth(app({ trips: [makeTrip({ date: '2026-06-02' }), makeTrip({ date: '2026-08-20' })] }), '2026-09-15')).toBe('2026-06')
